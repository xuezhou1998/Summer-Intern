...
if __name__ == '__main__':
    train_dir = './dataset_classification/train1'
    train_txt = './dataset_classification/train1.txt'
    train_data = get_files_list(train_dir)
    write_txt(train_data, train_txt, mode='w')

    val_dir = './dataset_classification/val1'
    val_txt = './dataset_classification/val1.txt'
