...
checkpoint = ModelCheckpoint("binary_classification_small_keras.h5", monitor='val_acc', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
