...
def create_records(image_dir,file, output_record_dir, resize_height, resize_width,shuffle,log=5):
    ...
    writer = tf.io.TFRecordWriter(output_record_dir)
...
if __name__ == '__main__':
    ...
    log=5
    # 产生train.record文件
    image_dir='/Users/xuezhouwen/Desktop/tensorflow_models_learning/dataset/train'
    train_labels = '/Users/xuezhouwen/Desktop/tensorflow_models_learning/dataset/train.txt'  # 图片路径
    train_record_output = '/Users/xuezhouwen/Desktop/tensorflow_models_learning/dataset/record/train{}.tfrecords'.format(resize_height)
    create_records(image_dir,train_labels, train_record_output, resize_height, resize_width,shuffle,log)
    train_nums=get_example_nums(train_record_output)
    print("save train example nums={}".format(train_nums))

    # 产生val.record文件
    image_dir='/Users/xuezhouwen/Desktop/tensorflow_models_learning/dataset/val'
    val_labels = '/Users/xuezhouwen/Desktop/tensorflow_models_learning/dataset/val.txt'  # 图片路径
    val_record_output = '/Users/xuezhouwen/Desktop/tensorflow_models_learning/dataset/record/val{}.tfrecords'.format(resize_height)
