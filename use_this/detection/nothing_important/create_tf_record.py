...
if __name__ == '__main__':
    ...
    ##dataset_detection
    # 产生train.record文件
    image_dir='./dataset_detection/train1'
    train_labels = './dataset_detection/train1.txt'  # 图片路径
    train_record_output = './dataset_detection/record/train{}.tfrecords'.format(resize_height)
    create_records(image_dir,train_labels, train_record_output, resize_height, resize_width,shuffle,log)
    train_nums=get_example_nums(train_record_output)
    print("save train example nums={}".format(train_nums))

    # 产生val.record文件
    image_dir='./dataset_detection/val1'
    val_labels = './dataset_detection/val1.txt'  # 图片路径
    val_record_output = './dataset_detection/record/val{}.tfrecords'.format(resize_height)
